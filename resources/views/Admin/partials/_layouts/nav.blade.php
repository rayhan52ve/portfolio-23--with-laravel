<div class="nav-content d-flex">
    ...
    <div class="menu-container flex-grow-1">
        <ul id="menu" class="menu">
            ...
            <li>
                <a href="#favorites"
                    class="@if (url()->current() == route('educations.create')) active @elseif(url()->current() == route('educations.index')) active @endif">
                ...
                <ul id="favorites">
                    <li>
                        <a href="{{ route('educations.create') }}"
                            class="{{ url()->current() == route('educations.create') ? 'active' : '' }}">
                            <span class="">Add</span>
                        </a>
            ...
            <li>
                <a href="#experians"
                    class="@if (url()->current() == route('experiences.create')) active @elseif(url()->current() == route('experiences.index')) active @endif">
                ...
                <ul id="experians">
                    <li>
                        <a href="{{ route('experiences.create') }}"
                            class="{{ url()->current() == route('experiences.create') ? 'active' : '' }}">
            ...
            <li>
                <a href="#skils" class="@if (url()->current() == route('skils.create')) active @elseif(url()->current() == route('skils.index')) active @endif">
                    <i data-acorn-icon="cart" class="icon" data-acorn-size="18"></i>
                    <span class="label">Skils</span>
                </a>
                <ul id="skils">
                    <li>
                        <a href="{{ route('skils.create') }}"
                            class="{{ url()->current() == route('skils.create') ? 'active' : '' }}">
                            <span class="label">Add</span>
                        </a>
                        <a href="{{ route('skils.index') }}"
                            class="{{ url()->current() == route('skils.index') ? 'active' : '' }}">
                            <span class="label">List</span>
                        </a>
                    </li>
                </ul>
